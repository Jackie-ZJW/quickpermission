...
package com.zjwdev.quickpermission.dialog
...
import com.zjwdev.quickpermission.databinding.PermissionxDefaultDialogLayoutBinding
import com.zjwdev.quickpermission.databinding.PermissionxPermissionItemBinding
    ...
    private fun buildPermissionsLayout() {
        ...
        for (permission in permissions) {
            ...
            if ((permission in allSpecialPermissions && !tempSet.contains(permission))
                ...
                val itemBinding = PermissionxPermissionItemBinding.inflate(
                    layoutInflater,
                    binding.permissionsLayout,
                    false
                )
                when (permission) {
